...
<head>
    ...
    <title>Проект ЭраСтройМонтаж студии terexov</title>
        ...
        <div class="container">
            <div class="info__inner">
                <div class="general__top">
                    ...
                    <a href="https://annasotnikova.com" class="info__link">ersm-spb.ru</a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="container-fluid">
                <div class="info__banner">
                    <img src="/images/content/projects2x/ersm-main.png" alt="">
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="info__banner">
                    <img src="/images/content/projects2x/ersm-services.png" alt="">
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="info__banner">
                    <img src="/images/content/projects2x/ersm-2xmain.png" alt="">
                </div>
            </div>

            <div class="infotask">
                <div class="infotask__title">Продвижение</div>
                <div class="infotask__text">За несколько месяцев продвинули сайт в верхние позиции, сайт выдается всегда в верхней строке поиске, таким образом увеличили количество звонков в несколько раз.</div>
            </div>

            <div class="container-fluid">
                <div class="info__banner">
                    <img src="/images/content/projects2x/ersm-seo.png" alt="">
                </div>
            </div>
